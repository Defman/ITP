...
/**
 * An Actor object is an object which can move around on the screen using Turtle
 * Graphics. The class is abstract so it is not possible to instantiate it
 * directly.
 * 
...
abstract class Actor {
    ...
    /**
     * Creates a new Actor object in a Canvas, at a position (x,y) with angle theta
     * (radians).
     * 
     ...
     * 
     * @return A boolean representing whether or not this Actor is currently
     *         drawing.
     */
    ...
    /**
     * Returns the x-coordinate (in pixels) of this Actor. Will not necessarily be
     * an integer-value.
     * 
    ...
    /**
     * Returns the y-coordinate (in pixels) of this Actor. Will not necessarily be
     * an integer-value.
     * 
     * @return The x-coordinate (in pixels) of this Actor.
     */
    ...
    /**
     * Returns the angle that this Actor is facing (in degrees). Will always be in
     * the interval [0, 360).
     * 
    ...
    /**
     * Returns the current color of this Actor (as an integer to be used in
     * setColor()).
     * 
    ...
    /**
     * Sets the color to the specified color. Allowed values are: - "black" - "red"
     * - "blue" - "yellow" - "green" - "magenta" - any hex color, that is "#RRGGBB"
     * 
    ...
    /**
     * Sets the color to c, 0 <= c < 6 0: black, 1: red, 2: blue, 3: yellow, 4:
     * green, 5: magenta
     * 
     * Will set the color to Black if an integer outside the interval [0, 5] is
     * chosen.
     * 
     * @param i The new color of this Actor.
     */
