...
public class Turtle{
     ...
     * 
     * @param n     Number of sides.
     * @param delta Difference in length between two succeeding sides (equal to
     *              shortest side).
     */
    ...
    /**
     * Jumps to specified coordinates without drawing and without turning. Ends with
     * a penDown.
     * 
    ...
    /**
     * Jumps as specified without drawing and without turning. Ends with a penDow.
     * 
    ...
    public void jump(double x, double y) {
         ...
         * 
         * @param n   Number of squares.
         * @param gap Gap between adjacent squares. (equal to size of smallest square).
         */
    ...
    /**
     * Draws a pattern of squares, where each square immediately surrounds four
     * other squares. For each level of depth the size of the squares is divided by
     * 3.
     * 
     * @param n    Depth of pattern (for n=1 a sigle square is drawn).
     * @param size Size of largest square.
    ...
    /**
     * This method allows the instructors (and the students) to see whether all the
     * implemented methods in Turtle 1 work as expected.
     */
    ...
    /**
     * This method allows the instructors (and the students) to see whether all the
     * implemented methods in Turtle 2 work as expected.
     */
    ...
    /**
     * This STATIC method allows the instructors (and the students) to see whether
     * all the implemented methods in Turtle 1 work as expected.
     */
    ...
    /**
     * This STATIC method allows the instructors (and the students) to see whether
     * all the implemented methods in Turtle 2 work as expected.
     */
    ...
    /**
     * This STATIC method allows the instructors (and the students) to see whether
     * all the implemented methods in Turtle 1 and Turtle 2 work as expected.
     */
